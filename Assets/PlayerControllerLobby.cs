...
{/*
    ...
    public TMPro.TextMeshProUGUI healthInfo, ShieldInfo, magazineInfo, ammoInfo, GrenadeCharge;
    ...
    [Header("Stats")]
    public float damageBonus, fireRateBonus, movementSpeed, cooldownReduction, dashBaseCooldown,
